...
const FAQ = [
  ...
  },
  {
    id: 'vote',
    q: '과제 투표는 어떻게 하나요?',
    a: '관리자가 투표를 연 과제는 상단 [과제 투표] 메뉴에 올라옵니다. 과제를 고르면 제출된 '
     + '작품이 카드로 펼쳐지고, 마음에 드는 작품의 [투표하기] 를 누르면 됩니다. 표는 1인당 '
     + '정해진 개수만큼 줄 수 있고, 기간 안에는 언제든 취소하고 다시 넣을 수 있습니다. '
     + '본인 작품에는 투표할 수 없으며(관리자가 허용한 경우 제외), 누가 어디에 표를 줬는지는 '
     + '다른 회원에게 보이지 않습니다.',
  },
  {
    id: 'password',
    q: '비밀번호를 잊었어요.',
    a: '로그인 화면의 [비밀번호를 잊으셨나요?] 를 눌러 이메일을 남겨주세요. '
     + '메일이 자동으로 가지는 않고, 담당자 화면에 요청이 뜨면 임시 비밀번호를 발급해 '
     + '직접 전달해 드립니다. 받으신 뒤 [내 계정] 에서 새 비밀번호로 바꾸세요.',
  },
  {
    id: 'files',
    q: '어떤 파일을 첨부할 수 있나요?',
